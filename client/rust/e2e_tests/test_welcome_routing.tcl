...
spawn bash -c "cd .. && RUST_LOG=info cargo run --quiet -- --server http://localhost:$server_port --config $bob_config_dir unusedgroup bob"
...
eexpect "Successfully joined group"
